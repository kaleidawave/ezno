...
- Output/artefact performance (compiler): we want to serve the leanest modules
...
- Compatibility (TypeScript): we want to not diverge from TypeScript *the ubiquitous type checker*
- Compatibility (JavaScript): we want this to be a tool for JavaScript and work with those constraints and not break too much of its existing behaviours
